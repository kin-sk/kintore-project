      ...
      <v-card rounded="lg">
        ...
        <v-card-text class="pa-3">
          ...
          <template v-else>
            ...
            <v-divider v-if="selectedDayBody && selectedDayWorkoutGroups.length > 0" class="mb-3" />
            ...
            <!-- 記録なし -->
            <div v-if="!selectedDayBody && selectedDayWorkoutGroups.length === 0" class="text-center text-medium-emphasis py-6">
              <v-icon size="32" class="mb-2 d-block mx-auto">mdi-calendar-blank</v-icon>
              この日の記録はありません
            </div>
          </template>
        </v-card-text>
